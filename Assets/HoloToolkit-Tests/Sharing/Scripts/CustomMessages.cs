...
namespace HoloToolkit.Sharing.Tests
{
    ...
    public class CustomMessages : Singleton<CustomMessages>
    {
        ...
        public void SendGameObjectTransform(Vector3 position, Vector3 scale, Quaternion rotation)
        {
            ...
            {
                // Create an outgoing network message to contain all the info we want to send
                NetworkOutMessage msg = CreateMessage((byte)TestMessageID.GameObjectTransform);

                AppendGameObjectTransoform(msg, position, scale, rotation);
        ...
        private void AppendGameObjectTransoform(NetworkOutMessage msg, Vector3 position, Vector3 scale, Quaternion rotation)
        {
